...
init python:
    ...
    def sleep_get_process_c():
        global total_daily_time, wake_time_in_minute
        minutes_awake = (total_daily_time - wake_time_in_minute) % 1440
        phase = (minutes_awake / 1440.0) * 2 * math.pi
    ...
    def wake_up(new_wake_hour=None, new_wake_minute=None):
        global is_sleeping, wake_time_in_minute
        is_sleeping = False
